...
import {SEARCH_ICON} from '../assets/Image';
  ...
  const orders = [
    {
      ...
      price: '$652',
      imageUrl: require('../assets/vipPoster.png'),
      rating: 3,
      reorderable: true,
    },
    {
    ...
    return (
      <View style={styles.orderCard}>
        <View
          ...
          <View>
            <Text
              style={[
                styles.orderStatus,
                {
                  ...
                  color: item.status === 'Delivered' ? '#0C9409' : blackColor,
                },
              ]}>
              {item.status}
            </Text>
            <TouchableOpacity
              ...
              <Text style={[styles.viewProduct, {marginTop: 15}]}>
                View Product
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <View
          ...
          <View style={styles.orderDetails}>
            <Text
              style={[styles.orderTitle, {fontSize: 14, marginVertical: 10}]}>
              {item.title}
            </Text>
            <View style={[styles.orderInfo, {paddingBottom: 10}]}>
              <Text style={styles.orderAddress}>Quantity: {item.date}</Text>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
          ...
          <View style={styles.actionContainer}>
            {item.status === 'Delivered' && item.reorderable && (
              <TouchableOpacity
                style={[styles.reorderButton, {flexDirection: 'row'}]}>
