    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={{ paddingHorizontal: 16 }}>
        ...
        <View style={styles.shortcutContainer}>
          <TouchableOpacity style={styles.shortcut} onPress={()=>navigation.navigate("Saved")}>
          ...
          <TouchableOpacity style={styles.shortcut} onPress={()=>navigation.navigate("Cart")}>
        ...
        <View style={[styles.sectionContainer, {
          ...
          >
            <View style={styles.sectionRow}>
              <Image source={require('../assets/AccountScreen/Address.png')} style={{ width: 20, height: 20 }} />
