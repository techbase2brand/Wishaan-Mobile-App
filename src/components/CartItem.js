import { View, Text, Image, Pressable, TouchableOpacity, StyleSheet, ActivityIndicator } from 'react-native'
...
const { borderRadius5, alignJustifyCenter, flexDirectionRow, flex, alignItemsFlexEnd, resizeModeCover, borderWidth1 } = BaseStyle;
...
const CartItem = ({item}) => {
    return (
        <View
            ...
            style={
                [styles.productItem, {
                    borderWidth: 1, borderColor: "#E6E6E6", backgroundColor: whiteColor
                }]
            }>
            <Image
                resizeMethod="resize"
            ...
            <View style={[styles.productText, flex, alignJustifyCenter, flexDirectionRow]}>
                <View style={[flex]}>
                    ...
                    <Text style={[styles.productTitle, { color: "#808080", fontSize: 12, marginBottom: 20 }]}>
                        Color :  Black
                    </Text>
                ...
                <View>
                    ...
                    <View style={[styles.quantityContainer, , { backgroundColor: whiteColor, borderColor: blackColor }]}>
                        <TouchableOpacity onPress={()=>console.log("decriment")}>
                            <Text style={[styles.quantityButton, borderWidth1, { color: blackColor, borderColor: "#E6E6E6" }]}>-</Text>
                        </TouchableOpacity>
